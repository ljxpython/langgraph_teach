...
# Compatibility shim for raganything modalprocessors import
def get_pipeline_status_lock(workspace: str | None = None) -> NamespaceLock:
    """
    Return a reusable lock for the pipeline_status namespace.
    raganything<=1.2.x expects this helper to exist in lightrag.kg.shared_storage.
    """
    return get_namespace_lock("pipeline_status", workspace=workspace)
